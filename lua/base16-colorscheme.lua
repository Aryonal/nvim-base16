...
function M.setup(colors, config)
    ...
    hi.DiagnosticError                    = { guifg = M.colors.base08, guibg = darken(M.colors.base08, 0.6), gui = 'none', guisp = nil }
    hi.DiagnosticWarn                     = { guifg = M.colors.base0E, guibg = darken(M.colors.base0E, 0.6), gui = 'none', guisp = nil }
    hi.DiagnosticInfo                     = { guifg = M.colors.base05, guibg = darken(M.colors.base05, 0.6), gui = 'none', guisp = nil }
    hi.DiagnosticHint                     = { guifg = M.colors.base0C, guibg = darken(M.colors.base0C, 0.6), gui = 'none', guisp = nil }
